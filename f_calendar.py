...
def calendar_search(request):
	...
	eventsResult = service.events().list(calendarId='primary', timeMin=format_date[0], timeMax=format_date[1] , maxResults=100, singleEvents=True, orderBy='startTime').execute()
